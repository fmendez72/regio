...
ggpredict(m1, c("dim","NetPayer")) %>% plot(connect.lines=TRUE) +
  ylab("Predicted Probabilities") +
  xlab("") +
  theme_bw(base_size = 18) +
  theme(legend.title = element_blank()) +
  ggtitle("Article length by Frame") 
...
Last interaction is the visbility one.
...
```{r}
m4 = clmm(Tone ~ dim * (level + country + words + vis4) + (1|country) + (1|site), Hess = TRUE,
          data = df,
          threshold = "flexible")
...
Even more so when graphing this effect. Basically, on the positive tone Spain has virtually certain predicted probabilities.

<a href = "https://fmendez72.github.io/regio/">
![](images/spainModel.png)
