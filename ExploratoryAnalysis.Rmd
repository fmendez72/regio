...
There an issue with cell count when disaggregation of the Frames by country and level is explored. To overcome the problem of low or missing cell count we can reconceptualise at a higher level. The re-conceptualiastion, around Economics (socio-economic & values) vs Politics (governance & power), still fits concpetually while highlighting the overall problematique nicely: the Politics versus the Economics of CP.

#### <a href="https://fmendez72.github.io/regio/analysis/descriptives2.html" target="_blank">See frames by country</a>
<br/><br/>

# Descriptives: Dependent variables (Tone & Europeanization)
Both dependent variables are OK in terms of their distribution across the different groups of interest (mainly country and territorial level). Tone is a little worse than Europeanization, but overall OK.


#### <a href="https://fmendez72.github.io/regio/analysis/descriptives3.html" target="_blank">Tone by country</a>
<br/><br/>
